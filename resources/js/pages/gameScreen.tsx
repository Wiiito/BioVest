        ...
        <>
            <div className="h-screen w-screen bg-background">
                ...
                <div className="flex h-full w-full">
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="mr-2 flex size-10 items-center justify-center rounded-lg bg-foreground">
                                                    <div className="flex size-8 items-center justify-center rounded-md bg-white uppercase">
                                                        {letter}
                                                    </div>
                                                </div>
                    ...
                    <ProfileSidebar setState={setLeaderboard} />
                </div>
            </div>
            {leaderboard && <LeaderBoard setState={setLeaderboard} leaders={leaders} />}
        </>
    );
}
