...
export default function CategoryButton({ category }: { category: QuestionCategory }) {
    return (
        <Link className="w-[calc(1/3*100%-(1-1/3)*1.5rem)] lg:aspect-[2] xl:aspect-[3]" href={route('category.show', category.id)}>
